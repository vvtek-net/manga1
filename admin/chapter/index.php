...
<body>
    ...
    <div class="content">
        ...
        <a class="btn btn-success" href="create.php">Thêm Chương Mới</a>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?= $row['update_at'] ?></td>
                        <td>
                            <a href="edit.php?id=<?= $row['chapter_id'] ?>" class="btn btn-warning">Sửa</a>
                            <a href="delete.php?id=<?= $row['chapter_id'] ?>" onclick="return confirm('Are you sure?')" class="btn btn-danger">Xóa</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
