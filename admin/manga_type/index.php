...
<body>
    ...
    <div class="content">
        <h1>Manga Types</h1>
        <a class="ms-130 btn btn-success" href="create.php">Create New Type</a>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        <td><?= $row['type_name'] ?></td>
                        <td>
                            <a href="edit.php?id=<?= $row['type_id'] ?>">Edit</a>
                            <a href="delete.php?id=<?= $row['type_id'] ?>" onclick="return confirm('Are you sure?')">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
