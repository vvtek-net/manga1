...
<body>
    ...
    <div class="content">
        ...
        <a href="create.php" class="btn btn-success">Thêm Tài Khoản</a>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?= $row['role_id'] ?></td>
                        <td>
                            <a href="edit.php?id=<?= $row['acc_id'] ?>" class="btn btn-warning">Sửa</a>
                            <a href="delete.php?id=<?= $row['acc_id'] ?>" onclick="return confirm('Are you sure?')" class="btn btn-danger">Xóa</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
