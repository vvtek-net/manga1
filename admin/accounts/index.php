...
<body>
    ...
    <div class="content">
        <h1>Accounts List</h1>
        <a href="create.php" class="ms-130 btn btn-success">Create New Account</a>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?= $row['role_id'] ?></td>
                        <td>
                            <a href="edit.php?id=<?= $row['acc_id'] ?>">Edit</a>
                            <a href="delete.php?id=<?= $row['acc_id'] ?>" onclick="return confirm('Are you sure?')">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
