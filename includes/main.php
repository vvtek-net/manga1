         ...
         <div class="column-80">
          ...
          <!-- Chương Mới Cập Nhật -->
            ...
            <style>
                ...
                .weekly-item, .completed-item {
                    display: flex;
                    align-items: center;
                    padding: 10px 0;
                    border-bottom: 1px dotted #ccc;
                }
                .weekly-item a, .completed-item a {
                    margin-left: 10px;
                    text-decoration: none;
                    color: #333;
                }
                .weekly-list, .completed-list {
                    background: #f9f9f9;
                    padding: 20px;
                    border-radius: 8px;
                }
                ...
                <?php
                $rank = 1;
                $query = "SELECT * FROM manga ORDER BY nomination_number DESC LIMIT 10";
                $stmt = $conn->prepare($query);
                $stmt->execute();
